                ...
                <div className='py-8 mt-20 md:mt-24 flex flex-col md:flex-row space-y-10 md:space-y-0 md:space-x-10 lg:space-x-52'>
                    ...
                    <div>
                        ...
                        <p className='w-full text-base md:text-lg font-sans py-3 text-gray-700'>
                            With a strong background in web development, I deliver quality web applications and services to meet your business and project needs. Whether it's creating responsive websites, building Android apps, designing user-friendly interfaces, or boosting your digital presence, I've got you covered.
                        </p>
                        <button
                            type='submit'
